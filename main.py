...
operations = {'ADD':add, 'ADDITION':add, 'SUM':add, 'PLUS':add,
              'SUB':sub, 'DIFFRENCE':sub, 'MINUS':sub, 'SUBTRACT':sub,
              'LCM':lcm,"HCF":hcf,'PRODUCT':mul, 'MULTIPLICATION':mul, 'MUL':mul,
              'MULTIPLY':mul, 'DiVisION':div,'DIV':div, 'MOD':mod, 'REMANDER':mod,
              'MODULUS':mod }
...
l1.place(x=150,y=10)
l2 =Label(win, text="Create By Rohit",padx=3)
l2.place(x=188,y=40)
l3 = Label(win,text="What can i help you")
